...
############ OBSERVATION ##########
mapping_observation = {
        "effusion":["effusions","effusion","infiltrate"],
        "enlarged":["elevation","elevated","elongated", "dilated","enlarged","large","larger","expanded","well - expanded","hyperexpansion","enlargement","increased","increase","exaggerated","widening","widened","distention","distension","increased enlarged"],
        "opacity":["obscuration","opacity","opacities","opacified","opacification","obscures","obscuring","indistinct","indistinctness","haziness","not less distinct","blurring"],
        "thickening":["thickening","thickenings"],
        "drain":["drains","drain"],
        "normal":["normal","stable","unremarkable","top - normal","unchanged","better"],
        "clear":["clear","lucency"],
        "decrease":["decreased","lower","low","decrease"],
        "abnormal":["worse","abnormality","abnormalities","abnormal","deformity","disease","deformities","dysfunction"],
        "edema":["edema"],
...
"lymph node":["lymph node"],
    "nipple":["nipple"],
    "not well evaluated":["not well evaluated"],
    "operation":["operation"],
    "volume":["volume", "volumes"],
    "wire":["wire","wires"],
