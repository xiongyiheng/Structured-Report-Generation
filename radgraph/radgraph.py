...
class Radgraph(Dataset):
    def __init__(self, is_train, use_augment, data_path="/home/mlmi-matthias/physionet.org/files/mimic-cxr-jpg/2.0.0/files/",label_path = "/home/mlmi-kamilia/jingsong/cnn/radgraph/"):
    ...
    def __getitem__(self, idx):
        ...
        for file in os.listdir(self.img_path):
            if file.endswith('.jpg'):
                img_ls.extend(os.path.join(self.img_path,file))
        ...
        for i in range(len(img_ls)):
            ...
            img_ls_tensor.extend(transform(image))
        ...
        ###output
        rect ={}
        rect['gt_labels'] = torch.LongTensor(lb_ls)
...
if __name__ == "__main__":
    Radgraph(is_train=True,use_augment=False,img_path="/home/mlmi-matthias/physionet.org/files/mimic-cxr-jpg/2.0.0/files/",label_path="")
